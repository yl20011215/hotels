  ...
  for (const h of hotels){
    ...
    if (shown){
      for (const r of (h.rooms || [])){
        ...
        sub.innerHTML = `
          <td colspan="6">
            <div class="roomLineTop">
              <div class="roomLeft">
                ${rThumb}
                <div class="roomTypeCell roomTypeCell--compact">
                  <span class="roomArrow">↳</span>
                  <span class="roomTypeName">${escapeHtml(r.type)}</span>
                </div>
              </div>

              <div class="roomMid">
                <span class="roomMeta" title="Hours">⏱️ <b>${escapeHtml(r.hours)}</b></span>
                <span class="roomMeta" title="Price">💰 <b>${fmtMoney(r.price)}</b> <span class="unit">LKR</span></span>
              </div>
            ...
            <div class="roomLineNote">${escapeHtml(r.note || "")}</div>
          </td>
