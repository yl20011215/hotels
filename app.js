  ...
  for (const h of hotels){
    ...
    tr.innerHTML = `
      ...
      <td>
        <div class="actions">
	          <button
	            class="linkbtn iconbtn"
	            type="button"
	            title="${shown ? "Hide rooms" : "Show rooms"}"
	            aria-label="${shown ? "Hide rooms" : "Show rooms"}"
	            data-toggle="${h.id}">${shown ? "🙈" : "👁️"}</button>
	          <button
	            class="linkbtn iconbtn"
	            type="button"
	            title="Edit hotel"
	            aria-label="Edit hotel"
	            data-edit="${h.id}">✏️</button>
	          <button
	            class="linkbtn danger iconbtn"
	            type="button"
	            title="Delete hotel"
	            aria-label="Delete hotel"
	            data-del="${h.id}">🗑️</button>
        </div>
      </td>
    `;
    tbody.appendChild(tr);
